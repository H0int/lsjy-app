...
// AiProvider is exported from ai/entities/ai-provider.entity.ts directly
// Re-export via local reference to avoid cross-module resolution issues
...
export { TicketReply } from './ticket-reply.entity';
export { Faq } from './faq.entity';
export { AutomationRule } from './automation-rule.entity';
export { AutomationRuleLog } from './automation-rule-log.entity';
