...
@Injectable()
export class SparkProvider extends BaseAIProvider {
  readonly name = 'spark';
  readonly displayName = '讯飞星火';
  ...
  async getModels(): Promise<ModelInfo[]> {
    return [
      { id: 'generalv3.5', name: '星火 V3.5', capabilities: ['text', 'code'], maxContextLength: 8192, supportStream: true },
      { id: 'generalv3', name: '星火 V3', capabilities: ['text', 'code'], maxContextLength: 8192, supportStream: true },
      { id: 'lite', name: '星火 Lite (免费)', capabilities: ['text'], maxContextLength: 8192, supportStream: true, inputPrice: 0, outputPrice: 0 },
    ];
  }
}
