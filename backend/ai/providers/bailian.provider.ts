/**
 * 阿里云百练 Provider (DashScope OpenAI 兼容模式)
...
export class BailianProvider extends BaseAIProvider {
  ...
  async getModels(): Promise<ModelInfo[]> {
    return [
      { id: 'qwen-plus', name: '通义千问 Plus', capabilities: ['text', 'code'], maxContextLength: 131072, supportStream: true },
      { id: 'qwen-turbo', name: '通义千问 Turbo', capabilities: ['text', 'code'], maxContextLength: 131072, supportStream: true },
      { id: 'qwen-max', name: '通义千问 Max', capabilities: ['text', 'code'], maxContextLength: 32768, supportStream: true },
      { id: 'qwen-long', name: '通义千问 Long', capabilities: ['text'], maxContextLength: 10000000, supportStream: true },
      { id: 'qwen2.5-72b-instruct', name: '通义千问2.5 72B', capabilities: ['text', 'code'], maxContextLength: 131072, supportStream: true },
    ];
  }
}
