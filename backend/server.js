...
// ===== 内存数据存储 =====
const usersStore = [
  { id: 1, username: 'KF02V9', nickname: '罗总', email: 'ceo@lsjyapp.cn', phone: '', roles: ['boss', 'founder', 'ultimate_admin', 'super_admin', 'admin', 'operator'], status: 'active', avatar: '', gender: 1, bio: '罗圣纪元创始人', vipLevel: 99, membershipTier: 'founder', userType: 'founder', unlimited: true, coins: 999999999, totalRecharge: 999999999, createdAt: '2026-05-12T00:00:00Z' }, isHot: true, isFree: true,
  { id: 2, username: 'user1', nickname: '测试用户', email: 'test@test.com', phone: '13800138000', roles: ['user'], status: 'active', avatar: '', gender: 0, bio: '普通用户', createdAt: '2026-06-01T00:00:00Z' }, isHot: true, isFree: true,
  { id: 3, username: 'admin1', nickname: '管理员', email: 'admin@lsjyapp.cn', phone: '', roles: ['admin'], status: 'active', avatar: '', gender: 1, bio: '系统管理员', createdAt: '2026-03-01T00:00:00Z' }, isHot: true, isFree: true,
];

const announcementsStore = [
  { id: 1, title: '罗圣纪元平台正式上线', content: '欢迎使用罗圣纪元平台，我们提供AI智能服务、自媒体运营等六大业务板块。', createdAt: '2026-06-01T00:00:00Z', updatedAt: '2026-06-01T00:00:00Z', status: 'published', author: '罗总' }, isHot: true, isFree: true,
  { id: 2, title: 'AI功能升级通知', content: '平台AI能力全面升级，支持更多模型和工具。', createdAt: '2026-06-10T00:00:00Z', updatedAt: '2026-06-10T00:00:00Z', status: 'published', author: '管理员' }, isHot: true, isFree: true,
];

const couponsStore = [
  { id: 1, name: '新用户专享', code: 'NEWUSER2026', discount: 20, minAmount: 100, validFrom: '2026-06-01', validTo: '2026-12-31', status: 'active', usedCount: 58, maxUses: 1000 }, isHot: true, isFree: true,
  { id: 2, name: 'VIP专属', code: 'VIP888', discount: 50, minAmount: 200, validFrom: '2026-06-01', validTo: '2026-09-30', status: 'active', usedCount: 12, maxUses: 500 }, isHot: true, isFree: true,
];

const campaignsStore = [
  { id: 1, name: '618大促', status: 'active', startDate: '2026-06-01', endDate: '2026-06-18', description: '618购物节优惠活动', participants: 320 }, isHot: true, isFree: true,
  { id: 2, name: '暑期特惠', status: 'upcoming', startDate: '2026-07-01', endDate: '2026-08-31', description: '暑期促销活动', participants: 0 }, isHot: true, isFree: true,
];

const ticketsStore = [
  { id: 1, userId: 2, title: '充值未到账', content: '充值100元但未到账', status: 'open', priority: 'high', assignee: '客服小王', createdAt: '2026-06-13T10:00:00Z', replies: [] }, isHot: true, isFree: true,
  { id: 2, userId: 2, title: '功能建议', content: '希望能增加批量导出功能', status: 'open', priority: 'low', assignee: null, createdAt: '2026-06-14T08:00:00Z', replies: [] }, isHot: true, isFree: true,
];

const faqsStore = [
  { id: 1, question: '如何注册账号？', answer: '点击注册按钮，填写用户名和密码即可。注册后可进入用户端使用 AI 智能体、圣力中心和会员服务。', category: '账号相关', sortOrder: 1, searchCount: 156, status: 'active' }, isHot: true, isFree: true,
  { id: 2, question: '如何充值圣力？', answer: '进入圣力中心，选择圣力套餐或会员订阅，提交支付订单后由后台财务中心审核，审核通过后圣力自动到账。', category: '支付充值', sortOrder: 2, searchCount: 230, status: 'active' }, isHot: true, isFree: true,
  { id: 3, question: 'AI 工具怎么使用？', answer: '进入 AI 工具中心或智能体页面，选择合适的工具，输入需求后即可生成文案、图片、视频、分析报告等内容。', category: 'AI工具', sortOrder: 3, searchCount: 189, status: 'active' }, isHot: true, isFree: true,
  { id: 4, question: '优惠券如何使用？', answer: '可在活动、充值或会员场景领取优惠券。满足使用门槛后，系统会在对应订单中展示可用优惠。', category: '电商购物', sortOrder: 4, searchCount: 88, status: 'active' }, isHot: true, isFree: true,
  { id: 5, question: '课程学习内容在哪里？', answer: '平台会逐步开放教程、知识库和课程学习内容，用户可以在内容库或相关智能体中查看。', category: '课程学习', sortOrder: 5, searchCount: 66, status: 'active' }, isHot: true, isFree: true,
  { id: 6, question: '宠物服务能做什么？', answer: '宠物服务类智能体可辅助宠物喂养、训练、用品选购、宠物店经营和宠物内容创作。', category: '宠物服务', sortOrder: 6, searchCount: 52, status: 'active' }, isHot: true, isFree: true,
];

const automationRulesStore = [
  { id: 1, name: '新用户自动欢迎', description: '用户注册后自动发送欢迎通知', triggerEvent: 'user_register', actions: [{ type: 'send_notification', config: {} }], status: 'active', executionCount: 0, lastExecutedAt: null, createdAt: '2026-05-01T00:00:00Z' }, isHot: true, isFree: true,
  { id: 2, name: '首次充值奖励', description: '用户首次充值后自动发放圣力奖励', triggerEvent: 'first_recharge', actions: [{ type: 'send_coins', config: { amount: 30 } }], status: 'active', executionCount: 0, lastExecutedAt: null, createdAt: '2026-05-10T00:00:00Z' }, isHot: true, isFree: true,
  { id: 3, name: '邀请成功提醒', description: '用户邀请好友成功后发送通知并记录分销关系', triggerEvent: 'invite_success', actions: [{ type: 'send_notification', config: {} }], status: 'disabled', executionCount: 0, lastExecutedAt: null, createdAt: '2026-06-01T00:00:00Z' }, isHot: true, isFree: true,
];

const moderationStore = [
  { id: 1, contentType: 'post', type: 'post', contentTitle: '用户发布的活动咨询帖', title: '用户发布的活动咨询帖', authorName: '测试用户', summary: '咨询罗圣纪元平台活动、优惠券和圣力使用规则，需要人工确认内容是否合规。', content: '用户发布的活动咨询帖：想了解圣力活动和会员优惠。', status: 'pending', userId: 2, createdAt: '2026-06-14T09:00:00Z', reason: '' }, isHot: true, isFree: true,
  { id: 2, contentType: 'comment', type: 'comment', contentTitle: 'AI生成内容评论', title: 'AI生成内容评论', authorName: '罗总', summary: 'AI生成的内容说明，已通过审核。', content: 'AI生成内容评论：平台功能介绍清晰，无违规内容。', status: 'approved', userId: 1, createdAt: '2026-06-13T15:00:00Z', reason: '' }, isHot: true, isFree: true,
];

const systemLogsStore = [
  { id: 1, level: 'info', module: 'auth', message: '用户KF02V9登录成功', ip: '127.0.0.1', createdAt: '2026-06-14T10:00:00Z' }, isHot: true, isFree: true,
  { id: 2, level: 'info', module: 'ai', message: 'AI工具调用: 罗圣AI智能体', ip: '127.0.0.1', createdAt: '2026-06-14T10:01:00Z' }, isHot: true, isFree: true,
  { id: 3, level: 'warn', module: 'payment', message: '充值订单处理延迟', ip: '127.0.0.1', createdAt: '2026-06-14T10:02:00Z' }, isHot: true, isFree: true,
];
...
const coinTransactionsStore = [
  { id: 1, userId: 1, type: 'recharge', amount: 50000, balance: 99999, description: '充值50000币', createdAt: '2026-06-01T00:00:00Z' }, isHot: true, isFree: true,
  { id: 2, userId: 1, type: 'consume', amount: -100, balance: 99899, description: '使用AI工具消耗', createdAt: '2026-06-10T00:00:00Z' }, isHot: true, isFree: true,
  { id: 3, userId: 2, type: 'recharge', amount: 500, balance: 500, description: '首次充值', createdAt: '2026-06-12T00:00:00Z' }, isHot: true, isFree: true,
];

const paymentOrdersStore = [
  { id: 1, orderNo: 'LSJY20260601001', userId: 1, amount: 129.9, coins: 2000, status: 'completed', payMethod: 'wechat', createdAt: '2026-06-01T10:00:00Z' }, isHot: true, isFree: true,
  { id: 2, orderNo: 'LSJY20260610001', userId: 2, amount: 39.9, coins: 500, status: 'pending', payMethod: 'alipay', createdAt: '2026-06-10T14:00:00Z' }, isHot: true, isFree: true,
];
...
const aiHistoryStore = [
  { id: 1, userId: 1, toolId: 1, toolName: '罗圣AI智能体', input: '你好', output: '你好！我是罗圣AI智能体...', model: 'coze', tokens: 120, createdAt: '2026-06-14T09:00:00Z' }, isHot: true, isFree: true,
  { id: 2, userId: 1, toolId: 2, toolName: '文案创作', input: '帮我写一段产品介绍', output: '这是一个划时代的产品...', model: 'deepseek', tokens: 350, createdAt: '2026-06-14T09:30:00Z' }, isHot: true, isFree: true,
];
...
const aiToolsStore = [
  { id: 1, name: '罗圣AI智能体', icon: '🤖', toolType: 'text', categoryId: 4, status: 'active', description: '全能AI助手，支持多轮对话、问答、咨询', isFree: false, systemPrompt: "你是\"罗圣AI智能体\"，由祁阳市罗圣纪元互联网科技有限责任公司开发。全能型AI助手，能回答各类问题。创始人是罗凯中。回复准确、专业、友好。", usageCount: 1256, coinCost: 1, subCategory: '对话聊天' }, isHot: true,
  { id: 2, name: '文案创作大师', icon: '✍️', toolType: 'text', categoryId: 1, status: 'active', description: '营销文案、宣传稿、社交媒体内容创作', isFree: false, systemPrompt: "你是专业营销文案创作大师，擅长撰写营销文案、宣传稿、广告语。输出有创意、有感染力、能转化。", usageCount: 890, coinCost: 2, subCategory: '文案撰写' }, isHot: true,
  ...
  { id: 4, name: '数据分析师', icon: '📊', toolType: 'analysis', categoryId: 4, status: 'active', description: '数据分析、商业洞察、趋势预测', isFree: false, systemPrompt: "你是资深数据分析师，擅长商业数据分析、市场洞察。回复有数据支撑，逻辑清晰。", usageCount: 210, coinCost: 3, subCategory: '数据分析' }, isHot: true,
  { id: 5, name: '代码工程师', icon: '💻', toolType: 'text', categoryId: 4, status: 'active', description: '代码生成、调试、技术方案设计', isFree: false, systemPrompt: "你是资深全栈工程师，精通前后端开发、数据库设计。代码有注释，方案可落地。", usageCount: 156, coinCost: 3, subCategory: '编程开发' }, isHot: true,
  { id: 6, name: '自媒体运营官', icon: '📱', toolType: 'text', categoryId: 1, status: 'active', description: '自媒体内容策划、运营策略、涨粉技巧', isFree: false, systemPrompt: "你是资深自媒体运营专家，精通抖音/小红书/公众号/B站运营。回复实操、有案例。", usageCount: 345, coinCost: 2, subCategory: '账号运营' }, isHot: true,
  { id: 7, name: '电商顾问', icon: '🛒', toolType: 'text', categoryId: 7, status: 'active', description: '电商运营、选品策略、店铺优化', isFree: false, systemPrompt: "你是电商运营专家，精通淘宝/京东/拼多多/抖音电商。回复有数据、有案例、可执行。", usageCount: 278, coinCost: 2, subCategory: '商品运营' }, isHot: true,
  { id: 8, name: '教育导师', icon: '📚', toolType: 'text', categoryId: 8, status: 'active', description: '课程推荐、学习规划、技能培训', isFree: false, systemPrompt: "你是资深教育专家，擅长课程规划、学习方法指导。回复专业、有温度、可执行。", usageCount: 189, coinCost: 2, subCategory: '学习方法' }, isHot: true,
  { id: 9, name: '宠物顾问', icon: '🐾', toolType: 'text', categoryId: 5, status: 'active', description: '宠物养护、训练指导、宠物用品推荐', isFree: false, systemPrompt: "你是宠物养护专家，精通猫狗饲养、训练、健康管理。回复专业、有爱心、实用。", usageCount: 134, coinCost: 2, subCategory: '养宠指导' }, isHot: true,
  { id: 10, name: '校园助手', icon: '🎓', toolType: 'text', categoryId: 6, status: 'active', description: '伯雅校园服务、学业辅导、校园生活', isFree: false, systemPrompt: "你是伯雅校园智能助手，为学生提供学习建议、生活指导、职业规划。回复亲切实用。", usageCount: 267, coinCost: 1, subCategory: '校园生活' }, isHot: true,
...
const rolesStore = [
  { id: 1, name: 'boss', displayName: '罗总专属', level: 999, permissions: ['*'], description: '最高权限，拥有所有决定权和执行权' }, isHot: true, isFree: true,
  { id: 2, name: 'admin', displayName: '系统管理员', level: 4, permissions: ['user.manage', 'content.manage', 'system.manage'], description: '管理后台权限' }, isHot: true, isFree: true,
  { id: 3, name: 'editor', displayName: '内容编辑', level: 3, permissions: ['content.manage'], description: '内容管理权限' }, isHot: true, isFree: true,
  { id: 4, name: 'user', displayName: '普通用户', level: 1, permissions: [], description: '基础使用权限' }, isHot: true, isFree: true,
];

const notificationsStore = [
  { id: 1, userId: 1, title: '新用户注册', content: '用户user1已注册并等待审批', type: 'system', read: false, createdAt: '2026-06-14T08:00:00Z' }, isHot: true, isFree: true,
  { id: 2, userId: 1, title: '工单待处理', content: '有2个工单等待处理', type: 'ticket', read: false, createdAt: '2026-06-14T09:00:00Z' }, isHot: true, isFree: true,
  { id: 3, userId: 1, title: '系统更新完成', content: '系统已成功更新至v2.0', type: 'system', read: true, createdAt: '2026-06-13T00:00:00Z' }, isHot: true, isFree: true,
];

// ===== API错误记录 =====
const apiErrorsStore = [
  { id: 1, toolId: 3, toolName: 'AI绘画师', apiProvider: 'jimeng', errorCode: 'TIMEOUT', errorMessage: '请求超时，API响应时间超过60秒', status: 'pending', retryCount: 2, createdAt: '2026-06-25T10:30:00Z', resolvedAt: null, resolvedBy: null }, isHot: true, isFree: true,
  { id: 2, toolId: 1, toolName: '罗圣AI智能体', apiProvider: 'deepseek', errorCode: 'RATE_LIMIT', errorMessage: '请求频率超限，请稍后重试', status: 'resolved', retryCount: 1, createdAt: '2026-06-24T15:20:00Z', resolvedAt: '2026-06-24T15:25:00Z', resolvedBy: 'admin' }, isHot: true, isFree: true,
  { id: 3, toolId: 5, toolName: '代码工程师', apiProvider: 'deepseek', errorCode: 'INVALID_RESPONSE', errorMessage: 'API返回格式异常，无法解析', status: 'pending', retryCount: 0, createdAt: '2026-06-26T08:15:00Z', resolvedAt: null, resolvedBy: null }, isHot: true, isFree: true,
];

// ===== 支付失败记录 =====
const paymentFailuresStore = [
  { id: 1, userId: 2, username: 'user1', orderId: 'ORD-20260625-001', amount: 99.00, paymentMethod: 'wechat', errorCode: 'PAY_TIMEOUT', errorMessage: '支付超时，用户未完成支付', status: 'pending', retryCount: 0, createdAt: '2026-06-25T14:30:00Z', resolvedAt: null, resolvedBy: null }, isHot: true, isFree: true,
  { id: 2, userId: 3, username: 'admin1', orderId: 'ORD-20260624-002', amount: 49.90, paymentMethod: 'alipay', errorCode: 'INSUFFICIENT_BALANCE', errorMessage: '余额不足', status: 'resolved', retryCount: 1, createdAt: '2026-06-24T09:10:00Z', resolvedAt: '2026-06-24T10:00:00Z', resolvedBy: 'admin' }, isHot: true, isFree: true,
];
...
const adminRolesStore = [
  { id: 1, name: 'boss', displayName: 'Boss账号', description: '罗总最高权限，拥有平台所有模块的查看、审核、配置和删除权限', permissions: ['*'], userCount: 1, status: '启用', scope: '全平台' }, isHot: true, isFree: true,
  { id: 2, name: 'finance_admin', displayName: '财务管理员', description: '负责充值审核、订单管理、提现审核、佣金结算和支付异常处理', permissions: ['dashboard:view', 'finance:manage', 'payment:review', 'withdraw:review', 'commission:manage'], userCount: 0, status: '启用', scope: '财务中心' }, isHot: true, isFree: true,
  { id: 3, name: 'operation_admin', displayName: '运营管理员', description: '负责内容审核、活动、优惠券、消息推送、内容库和用户反馈', permissions: ['dashboard:view', 'content:manage', 'campaign:manage', 'coupon:manage', 'message:push', 'feedback:manage'], userCount: 0, status: '启用', scope: '运营管理' }, isHot: true, isFree: true,
  { id: 4, name: 'support_admin', displayName: '客服管理员', description: '负责FAQ、工单、意见反馈、用户标签和自动化规则执行', permissions: ['dashboard:view', 'faq:manage', 'ticket:manage', 'feedback:manage', 'automation:manage'], userCount: 0, status: '启用', scope: '客服自动化' }, isHot: true, isFree: true,
  { id: 5, name: 'system_admin', displayName: '系统管理员', description: '负责系统监控、API错误、缓存、备份、敏感词、系统配置和操作日志', permissions: ['dashboard:view', 'system:manage', 'api:manage', 'cache:manage', 'backup:manage', 'audit:view'], userCount: 0, status: '启用', scope: '系统管理' }, isHot: true, isFree: true,
  { id: 6, name: 'viewer', displayName: '只读观察员', description: '只能查看数据看板、访客、定位、财务统计和运营统计，不能修改数据', permissions: ['dashboard:view', 'users:view', 'finance:view', 'content:view', 'audit:view'], userCount: 0, status: '停用', scope: '只读' }, isHot: true, isFree: true,
];
...
app.get('/api/v1/ai/categories', (req, res) => {
  res.json({
    code: 0, message: 'success',
    data: [
      { id: 1, name: '内容创作', icon: '📝', description: '文案撰写、视频脚本、直播运营' }, isHot: true, isFree: true,
      { id: 4, name: 'AI智能', icon: '🤖', description: 'AI助手、对话问答、编程开发' }, isHot: true, isFree: true,
      { id: 7, name: '电商运营', icon: '🛒', description: '商品运营、店铺管理、直播带货' }, isHot: true, isFree: true,
      { id: 8, name: '教育培训', icon: '📚', description: '课程规划、学习方法、考试辅导' }, isHot: true, isFree: true,
      { id: 5, name: '宠物服务', icon: '🐾', description: '宠物养护、训练指导、宠物用品' }, isHot: true, isFree: true,
      { id: 6, name: '校园助手', icon: '🎓', description: '伯雅校园、学业辅导、校园生活' }, isHot: true, isFree: true,
      { id: 9, name: '图片生成', icon: '🎨', description: 'AI绘画、海报设计、Logo创作', filterType: 'image' }, isHot: true, isFree: true,
      { id: 10, name: '视频生成', icon: '🎬', description: 'AI视频生成、动画制作', filterType: 'video' }, isHot: true, isFree: true,
    ],
  });
});
...
try { _kb = JSON.parse(fs.readFileSync(_kbFile, 'utf8')); } catch(e) {
  _kb = [
    { id: 1, type: 'faq', title: '什么是圣力？', content: '圣力是罗圣纪元平台的虚拟货币，用于调用AI工具和服务。', createdAt: new Date().toISOString() }, isHot: true, isFree: true,
    { id: 2, type: 'guide', title: '如何充值圣力？', content: '进入圣力中心，选择套餐，扫码支付即可。', createdAt: new Date().toISOString() }, isHot: true, isFree: true,
    { id: 3, type: 'policy', title: '退款政策', content: '未使用的圣力可在7天内申请退款。', createdAt: new Date().toISOString() }, isHot: true, isFree: true
  ];
...
try { _vip = JSON.parse(fs.readFileSync(_vipFile, 'utf8')); } catch(e) {
  _vip = [
    { id: 1, name: '月卡VIP', price: 29.9, duration: 30, dailyCoins: 100 }, isHot: true, isFree: true,
    { id: 2, name: '季卡VIP', price: 79.9, duration: 90, dailyCoins: 150 }, isHot: true, isFree: true,
    { id: 3, name: '年卡VIP', price: 299.9, duration: 365, dailyCoins: 200 }, isHot: true, isFree: true
  ];
...
const commissionStore = [
  { id: 1, userId: 2, username: 'user1', orderId: 'ORD-20260620-001', orderAmount: 199, commissionRate: 0.1, commissionAmount: 19.9, status: 'settled', createdAt: '2026-06-20T10:00:00Z', settledAt: '2026-06-25T00:00:00Z' }, isHot: true, isFree: true,
  { id: 2, userId: 2, username: 'user1', orderId: 'ORD-20260622-002', orderAmount: 99, commissionRate: 0.1, commissionAmount: 9.9, status: 'pending', createdAt: '2026-06-22T14:00:00Z', settledAt: null }, isHot: true, isFree: true,
  { id: 3, userId: 3, username: 'admin1', orderId: 'ORD-20260624-003', orderAmount: 299, commissionRate: 0.15, commissionAmount: 44.85, status: 'pending', createdAt: '2026-06-24T16:00:00Z', settledAt: null }, isHot: true, isFree: true,
];

// ===== 提现数据 =====
const withdrawStore = [
  { id: 1, userId: 2, username: 'user1', amount: 100, fee: 2, actualAmount: 98, method: 'wechat', account: 'wx_user1', status: 'approved', createdAt: '2026-06-18T10:00:00Z', processedAt: '2026-06-19T08:00:00Z' }, isHot: true, isFree: true,
  { id: 2, userId: 2, username: 'user1', amount: 50, fee: 1, actualAmount: 49, method: 'alipay', account: 'user1@alipay.com', status: 'pending', createdAt: '2026-06-25T14:00:00Z', processedAt: null }, isHot: true, isFree: true,
];

// ===== 分销数据 =====
const distributionStore = {
  links: [
    { id: 1, userId: 2, username: 'user1', code: 'USER1DIST', link: 'https://lsjyapp.cn/?ref=USER1DIST', clicks: 234, conversions: 18, commission: 356.5, createdAt: '2026-06-01T00:00:00Z' }, isHot: true, isFree: true,
    { id: 2, userId: 3, username: 'admin1', code: 'ADMIN1DIST', link: 'https://lsjyapp.cn/?ref=ADMIN1DIST', clicks: 89, conversions: 5, commission: 120.0, createdAt: '2026-06-10T00:00:00Z' }, isHot: true, isFree: true,
  ],
...
const affiliatesStore = [
  { id: 1, name: '伯雅教育', contact: '张经理', phone: '13800000001', email: 'zhang@boya.edu', type: 'education', status: 'active', revenue: 45000, commission: 4500, joinedAt: '2026-05-01T00:00:00Z' }, isHot: true, isFree: true,
  { id: 2, name: '长沙宠物医院', contact: '李医生', phone: '13800000002', email: 'li@petcare.com', type: 'pet', status: 'active', revenue: 28000, commission: 2800, joinedAt: '2026-05-15T00:00:00Z' }, isHot: true, isFree: true,
  { id: 3, name: '祁阳自媒体联盟', contact: '王总', phone: '13800000003', email: 'wang@qyzmt.com', type: 'media', status: 'pending', revenue: 0, commission: 0, joinedAt: '2026-06-20T00:00:00Z' }, isHot: true, isFree: true,
];

// ===== 推送消息数据 =====
const pushMessagesStore = [
  { id: 1, title: '系统维护通知', content: '今晚22:00-23:00系统维护', type: 'system', target: 'all', status: 'sent', sentAt: '2026-06-24T20:00:00Z', readCount: 156, totalCount: 200 }, isHot: true, isFree: true,
  { id: 2, title: '新功能上线', content: 'AI视频生成功能已上线，快来体验！', type: 'feature', target: 'all', status: 'sent', sentAt: '2026-06-20T10:00:00Z', readCount: 89, totalCount: 180 }, isHot: true, isFree: true,
  { id: 3, title: '充值优惠', content: '618充值8折活动进行中', type: 'promotion', target: 'all', status: 'draft', sentAt: null, readCount: 0, totalCount: 0 }, isHot: true, isFree: true,
];

// ===== 黑名单数据 =====
const blacklistStore = {
  users: [
    { id: 1, userId: 99, username: 'spammer01', reason: '发布垃圾信息', bannedBy: 'admin', bannedAt: '2026-06-15T10:00:00Z', expiresAt: '2026-09-15T10:00:00Z' }, isHot: true, isFree: true,
    { id: 2, userId: 100, username: 'abuser02', reason: '恶意攻击其他用户', bannedBy: 'admin', bannedAt: '2026-06-20T14:00:00Z', expiresAt: null }, isHot: true, isFree: true,
  ],
  ips: [
    { id: 1, ip: '192.168.1.100', reason: '恶意爬虫', blockedBy: 'system', blockedAt: '2026-06-18T08:00:00Z' }, isHot: true, isFree: true,
    { id: 2, ip: '10.0.0.55', reason: 'DDoS攻击', blockedBy: 'system', blockedAt: '2026-06-22T03:00:00Z' }, isHot: true, isFree: true,
  ]
};

// ===== 用户标签数据 =====
const userTagsStore = [
  { id: 1, name: 'VIP用户', color: '#FFD700', count: 12, description: '付费VIP会员' }, isHot: true, isFree: true,
  { id: 2, name: '活跃用户', color: '#00FF88', count: 45, description: '近7天有登录' }, isHot: true, isFree: true,
  { id: 3, name: '新用户', color: '#00BFFF', count: 8, description: '注册30天内' }, isHot: true, isFree: true,
  { id: 4, name: '高风险', color: '#FF4444', count: 3, description: '异常行为标记' }, isHot: true, isFree: true,
  { id: 5, name: 'AI重度用户', color: '#FF69B4', count: 20, description: '日均AI调用>10次' }, isHot: true, isFree: true,
];

// ===== 敏感词数据 =====
const sensitiveWordsStore = [
  { id: 1, word: '赌博', category: '违法', level: 'high', hitCount: 23, createdAt: '2026-05-01T00:00:00Z' }, isHot: true, isFree: true,
  { id: 2, word: '代孕', category: '违法', level: 'high', hitCount: 8, createdAt: '2026-05-01T00:00:00Z' }, isHot: true, isFree: true,
  { id: 3, word: '发票', category: '广告', level: 'medium', hitCount: 45, createdAt: '2026-05-10T00:00:00Z' }, isHot: true, isFree: true,
  { id: 4, word: '加微信', category: '引流', level: 'low', hitCount: 120, createdAt: '2026-05-15T00:00:00Z' }, isHot: true, isFree: true,
];

// ===== 聊天日志数据 =====
const chatLogsStore = [
  { id: 1, userId: 2, username: 'user1', toolName: '罗圣AI智能体', input: '帮我写一段营销文案', output: '好的，以下是一段营销文案...', tokens: 350, duration: 2.3, createdAt: '2026-06-25T10:00:00Z' }, isHot: true, isFree: true,
  { id: 2, userId: 2, username: 'user1', toolName: 'AI绘画师', input: '画一只可爱的猫咪', output: '[图片已生成]', tokens: 120, duration: 8.5, createdAt: '2026-06-25T10:30:00Z' }, isHot: true, isFree: true,
  { id: 3, userId: 1, username: 'KF02V9', toolName: '代码工程师', input: '写一个排序算法', output: 'function quickSort(arr)...', tokens: 280, duration: 1.8, createdAt: '2026-06-25T11:00:00Z' }, isHot: true, isFree: true,
];

// ===== 内容库数据 =====
const contentLibraryStore = [
  { id: 1, title: '罗圣纪元公司介绍文章', type: '文章', summary: '介绍罗圣纪元的公司定位、AI赋能实体经济方向和服务场景。', content: '罗圣纪元是一家以AI赋能实体经济为核心方向的互联网科技公司，服务个人、商家、团队和本地实体业务。', author: '罗总', status: 'published', aiGenerated: false, views: 234, likes: 45, createdAt: '2026-06-20T10:00:00Z' }, isHot: true, isFree: true,
  { id: 2, title: '圣力充值与会员使用教程', type: '教程', summary: '说明圣力、充值套餐、会员订阅和后台审核流程。', content: '用户可以通过圣力中心购买套餐或会员，后台审核通过后自动发放圣力或开通会员权益。', author: '运营中心', status: 'published', aiGenerated: false, views: 567, likes: 89, createdAt: '2026-06-18T14:00:00Z' }, isHot: true, isFree: true,
  { id: 3, title: '平台运营公告模板', type: '公告', summary: '用于首页、消息推送和后台公告管理的标准公告内容。', content: '罗圣纪元平台功能持续升级，新增知识库、模型配置、财务中心和运营管理模块。', author: '运营中心', status: 'published', aiGenerated: false, views: 126, likes: 12, createdAt: '2026-06-22T09:00:00Z' }, isHot: true, isFree: true,
  { id: 4, title: '公司文化知识库摘要', type: '知识库', summary: '沉淀公司文化、来时路、业务板块和智能体回答口径。', content: '罗圣纪元坚持务实、长期、服务实体、帮助普通人使用AI。', author: '知识库', status: 'published', aiGenerated: true, views: 89, likes: 10, createdAt: '2026-07-05T00:00:00Z' }, isHot: true, isFree: true,
  { id: 5, title: '商家活动文案提示词模板', type: '提示词模板', summary: '适合生成优惠券活动、会员促销、短视频脚本和客服回复。', content: '请以罗圣纪元运营专家身份，为本地商家生成一份活动文案，包含标题、卖点、优惠规则、行动引导。', author: 'AI运营助手', status: 'draft', aiGenerated: true, views: 0, likes: 0, createdAt: '2026-07-05T00:05:00Z' }, isHot: true, isFree: true,
];

// ===== 圣力套餐数据 =====
const coinPackagesStore = [
  { id: 1, name: '体验包', coins: 10, coinAmount: 10, price: 1, originalPrice: 1, bonusCoins: 0, status: 'active', isRecommended: 0, sortOrder: 1, salesCount: 0 }, isHot: true, isFree: true,
  { id: 2, name: '入门包', coins: 100, coinAmount: 100, price: 9.9, originalPrice: 10, bonusCoins: 10, status: 'active', isRecommended: 0, sortOrder: 2, salesCount: 0 }, isHot: true, isFree: true,
  { id: 3, name: '标准包', coins: 300, coinAmount: 300, price: 24.9, originalPrice: 30, bonusCoins: 30, status: 'active', isRecommended: 0, sortOrder: 3, salesCount: 0 }, isHot: true, isFree: true,
  { id: 4, name: '进阶包', coins: 500, coinAmount: 500, price: 39.9, originalPrice: 50, bonusCoins: 100, status: 'active', isRecommended: 1, sortOrder: 4, salesCount: 0 }, isHot: true, isFree: true,
  { id: 5, name: '专业包', coins: 1000, coinAmount: 1000, price: 69.9, originalPrice: 100, bonusCoins: 200, status: 'active', isRecommended: 0, sortOrder: 5, salesCount: 0 }, isHot: true, isFree: true,
  { id: 6, name: '企业包', coins: 2000, coinAmount: 2000, price: 129.9, originalPrice: 200, bonusCoins: 500, status: 'active', isRecommended: 0, sortOrder: 6, salesCount: 0 }, isHot: true, isFree: true,
  { id: 7, name: '旗舰包', coins: 5000, coinAmount: 5000, price: 299.9, originalPrice: 500, bonusCoins: 1500, status: 'active', isRecommended: 0, sortOrder: 7, salesCount: 0 }, isHot: true, isFree: true,
  { id: 8, name: '至尊包', coins: 10000, coinAmount: 10000, price: 549.9, originalPrice: 1000, bonusCoins: 3500, status: 'active', isRecommended: 0, sortOrder: 8, salesCount: 0 }, isHot: true, isFree: true,
  { id: 9, name: '豪华包', coins: 25000, coinAmount: 25000, price: 1299.9, originalPrice: 2500, bonusCoins: 10000, status: 'active', isRecommended: 0, sortOrder: 9, salesCount: 0 }, isHot: true, isFree: true,
  { id: 10, name: '王者包', coins: 50000, coinAmount: 50000, price: 1999.9, originalPrice: 5000, bonusCoins: 25000, status: 'active', isRecommended: 0, sortOrder: 10, salesCount: 0 }, isHot: true, isFree: true,
];
...
// ===== 实时定位数据 =====
const locationStore = [
  { id: 1, userId: 1, username: 'KF02V9', lat: 26.6532, lng: 111.5341, city: '祁阳', address: '祁阳市中心', updatedAt: '2026-06-26T03:00:00Z' }, isHot: true, isFree: true,
  { id: 2, userId: 2, username: 'user1', lat: 28.2280, lng: 112.9388, city: '长沙', address: '长沙市岳麓区', updatedAt: '2026-06-26T03:05:00Z' }, isHot: true, isFree: true,
  { id: 3, userId: 3, username: 'admin1', lat: 23.1291, lng: 113.2644, city: '广州', address: '广州市天河区', updatedAt: '2026-06-26T02:50:00Z' }, isHot: true, isFree: true,
];
