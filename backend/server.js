...
2. 被问到"你的创始人是谁"时，回答：罗凯中先生，他同时担任罗圣纪元的董事长兼CEO
...
function getLocalResponse(userMessage) {
  ...
  if (msg.includes('创始人') || msg.includes('谁创') || msg.includes('谁建') || msg.includes('老板')) {
    return '罗圣纪元的创始人是**罗凯中**先生，他同时担任公司的**董事长兼CEO**。罗凯中先生创立了罗圣纪元一体化SaaS平台，致力于用AI技术赋能实体经济，平台涵盖AI智能服务、自媒体运营、电商、教育、宠物和伯雅校园六大业务板块。';
  }
