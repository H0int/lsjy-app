...
const aiToolsStore = [
  ...
  { id: 3, name: 'AI绘画师', icon: '🎨', toolType: 'image', categoryId: 4, status: 'active', description: 'AI图片生成、设计辅助', isFree: false, systemPrompt: "你是AI绘画提示词专家，能根据用户描述生成高质量绘画提示词。", usageCount: 432, coinCost: 50, subCategory: 'AI绘画' },
  ...
  { id: 27, name: '封面设计师', icon: '🖼️', toolType: 'image', categoryId: 1, status: 'active', description: '视觉设计专业工具', systemPrompt: "你是专业的封面设计师，专注于视觉设计领域服务。请根据用户需求提供专业、精准、可落地的回答。", usageCount: 474, coinCost: 50, subCategory: '视觉设计' },
  { id: 28, name: '调色师', icon: '🖼️', toolType: 'image', categoryId: 1, status: 'active', description: '视觉设计专业工具', systemPrompt: "你是专业的调色师，专注于视觉设计领域服务。请根据用户需求提供专业、精准、可落地的回答。", usageCount: 478, coinCost: 50, subCategory: '视觉设计' },
  { id: 29, name: '视频剪辑师', icon: '🖼️', toolType: 'image', categoryId: 1, status: 'active', description: '视觉设计专业工具', systemPrompt: "你是专业的视频剪辑师，专注于视觉设计领域服务。请根据用户需求提供专业、精准、可落地的回答。", usageCount: 284, coinCost: 50, subCategory: '视觉设计' },
  ...
  { id: 44, name: 'Logo设计师', icon: '🎨', toolType: 'image', categoryId: 4, status: 'active', description: 'AI绘画专业工具', systemPrompt: "你是专业的Logo设计师，专注于AI绘画领域服务。请根据用户需求提供专业、精准、可落地的回答。", usageCount: 43, coinCost: 50, subCategory: 'AI绘画' },
  { id: 45, name: '海报生成器', icon: '🎨', toolType: 'image', categoryId: 4, status: 'active', description: 'AI绘画专业工具', systemPrompt: "你是专业的海报生成器，专注于AI绘画领域服务。请根据用户需求提供专业、精准、可落地的回答。", usageCount: 165, coinCost: 50, subCategory: 'AI绘画' },
  { id: 46, name: '头像定制师', icon: '🎨', toolType: 'image', categoryId: 4, status: 'active', description: 'AI绘画专业工具', systemPrompt: "你是专业的头像定制师，专注于AI绘画领域服务。请根据用户需求提供专业、精准、可落地的回答。", usageCount: 382, coinCost: 50, subCategory: 'AI绘画' },
  { id: 47, name: '插画创作家', icon: '🎨', toolType: 'image', categoryId: 4, status: 'active', description: 'AI绘画专业工具', systemPrompt: "你是专业的插画创作家，专注于AI绘画领域服务。请根据用户需求提供专业、精准、可落地的回答。", usageCount: 127, coinCost: 50, subCategory: 'AI绘画' },
  { id: 48, name: '风格迁移师', icon: '🎨', toolType: 'image', categoryId: 4, status: 'active', description: 'AI绘画专业工具', systemPrompt: "你是专业的风格迁移师，专注于AI绘画领域服务。请根据用户需求提供专业、精准、可落地的回答。", usageCount: 491, coinCost: 50, subCategory: 'AI绘画' },
  { id: 49, name: '商品图生成', icon: '🎨', toolType: 'image', categoryId: 4, status: 'active', description: 'AI绘画专业工具', systemPrompt: "你是专业的商品图生成，专注于AI绘画领域服务。请根据用户需求提供专业、精准、可落地的回答。", usageCount: 217, coinCost: 50, subCategory: 'AI绘画' },
  { id: 50, name: '短视频生成器', icon: '🎬', toolType: 'video', categoryId: 4, status: 'active', description: 'AI视频专业工具', systemPrompt: "你是专业的短视频生成器，专注于AI视频领域服务。请根据用户需求提供专业、精准、可落地的回答。", usageCount: 205, coinCost: 100, subCategory: 'AI视频' },
  { id: 51, name: '视频字幕大师', icon: '🎬', toolType: 'video', categoryId: 4, status: 'active', description: 'AI视频专业工具', systemPrompt: "你是专业的视频字幕大师，专注于AI视频领域服务。请根据用户需求提供专业、精准、可落地的回答。", usageCount: 178, coinCost: 100, subCategory: 'AI视频' },
