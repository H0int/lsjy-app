...
window.toggleEliteMode=function(){
  ...
  if(fab) fab.innerHTML=isEliteMode?'\u{1F3E0}':'\u2666';
  // 更新所有精英版按钮文案
  document.querySelectorAll('.elite-toggle-btn').forEach(function(b){
    if(isEliteMode){b.innerHTML='<span>\u{1F3E0}</span> 切换个人版';}
...
// 8. 20款企业专属工具数据
var ELITE_TOOLS=[
  {id:'biz_plan',name:'商业计划书生成',cat:'enterprise',desc:'智能生成完整商业计划书，含市场分析、财务预测、运营策略',power:30,icon:'\u{1F4BC}'},
  {id:'comp_analysis',name:'竞品深度分析',cat:'enterprise',desc:'多维度竞品对比分析，输出SWOT矩阵与竞争策略建议',power:25,icon:'\u{1F50D}'},
  {id:'fin_forecast',name:'财务预测模型',cat:'enterprise',desc:'基于历史数据预测未来3年营收、成本和利润趋势',power:35,icon:'\u{1F4C8}'},
  {id:'risk_report',name:'风险评估报告',cat:'enterprise',desc:'识别业务风险点，输出风险评估矩阵和应对方案',power:20,icon:'\u26A0\uFE0F'},
  {id:'swot_analysis',name:'SWOT分析',cat:'enterprise',desc:'自动生成企业SWOT分析，含优势、劣势、机会、威胁',power:15,icon:'\u{1F4CA}'},
  {id:'meeting_notes',name:'智能会议纪要',cat:'enterprise',desc:'支持录音/视频上传，AI自动生成结构化会议纪要',power:25,icon:'\u{1F3A4}'},
  {id:'contract_review',name:'合同智能审核',cat:'enterprise',desc:'AI审核合同条款，标注风险点并提供修改建议',power:30,icon:'\u{1F4DD}'},
  {id:'staff_eval',name:'员工绩效考核',cat:'enterprise',desc:'生成绩效考核模板和评估报告，支持KPI/OKR体系',power:15,icon:'\u{1F465}'},
  {id:'pm_kanban',name:'项目管理看板',cat:'enterprise',desc:'可视化项目管理工具，支持任务分配和进度追踪',power:20,icon:'\u{1F4CB}'},
  {id:'marketing_plan',name:'全案营销方案',cat:'enterprise',desc:'一键生成完整营销策划方案，含渠道、预算、时间表',power:40,icon:'\u{1F3AF}'},
  {id:'ad_strategy',name:'投放策略优化',cat:'enterprise',desc:'AI优化广告投放策略，提升ROI和转化率',power:25,icon:'\u{1F4B0}'},
  {id:'sales_script',name:'客户转化话术',cat:'enterprise',desc:'生成销售话术和应对客户异议的标准回复',power:15,icon:'\u{1F4AC}'},
  {id:'sales_funnel',name:'销售漏斗分析',cat:'enterprise',desc:'可视化销售漏斗，识别转化瓶颈并优化流程',power:20,icon:'\u{1F3E6}'},
  {id:'priv_ops',name:'私域运营方案',cat:'enterprise',desc:'企业私域流量运营全套方案，含社群、朋友圈、活动策划',power:25,icon:'\u{1F310}'},
  {id:'brand_story',name:'品牌故事撰写',cat:'enterprise',desc:'AI生成企业品牌故事和品牌文化内容',power:15,icon:'\u{1F4D6}'},
  {id:'press_release',name:'新闻稿生成',cat:'enterprise',desc:'专业企业新闻稿和公关稿件AI生成',power:15,icon:'\u{1F4F0}'},
  {id:'crisis_pr',name:'危机公关话术',cat:'enterprise',desc:'企业危机公关应对方案和话术模板生成',power:20,icon:'\u{1F6E1}\uFE0F'},
  {id:'media_plan',name:'媒体投放方案',cat:'enterprise',desc:'智能推荐媒体投放组合和预算分配方案',power:25,icon:'\u{1F4FA}'},
  {id:'event_plan',name:'活动策划方案',cat:'enterprise',desc:'企业线上线下活动策划，含预算、流程、物料清单',power:30,icon:'\u{1F389}'},
  {id:'data_export',name:'批量数据导出',cat:'enterprise',desc:'一键导出团队所有生成内容，支持多格式',power:10,icon:'\u{1F4BE}'}
];
