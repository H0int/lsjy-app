...
const list = ref<Ticket[]>([
  { id: 1, ticketNo: 'TK20250718001', userId: 101, userName: '张三', subject: '充值圣力未到账', content: '我在今天上午10点左右充值了200元购买500圣力，支付已成功但圣力没有到账，订单号: PAY2025071800123。', category: 'payment', priority: 'high', status: 'open', assigneeId: null, assigneeName: null, replies: [], firstResponseAt: null, resolvedAt: null, createdAt: '2025-07-18 10:30', updatedAt: '2025-07-18 10:30' },
